...
class sale_order_new(models.Model):
    ...
    direccion_origen = fields.Char('Direccion origen')
    direccion_destino = fields.Char('Direccion destino')
    puerto_orig = fields.Many2one('res.country.puerto', 'Puerto de origen')
    aero_orig = fields.Many2one('res.country.aereo', 'Aeropuerto de origen')
    frontera_orig = fields.Many2one('res.country.frontera', 'Frontera de origen')
    direc_destino = fields.Char('Direccion de destino')
    puerto_dest = fields.Many2one('res.country.puerto', 'Puerto de destino')
    aero_destino = fields.Many2one('res.country.aereo', 'Aeropuerto de destino')
    front_destino = fields.Many2one('res.country.frontera', 'Frontera de destino')
    cant_contenedores = fields.Char('Cantidad de contenedores')
    ...
    pais_destino = fields.Many2one('res.country', 'Pais Destino')
    ...
    utilidad2 = fields.Float(compute='_amount_all_pricing', digits_compute=dp.get_precision('Account'), string='% de utilidad comercial',
        help="% de utilidad2.")
    puerto_carga = fields.Many2one('res.country.puerto', 'Puerto de carga (POL)')
    puerto_descarga = fields.Many2one('res.country.puerto', 'Puerto de descarga (POD)')
    aereo_origen = fields.Many2one('res.country.aereo', 'Aereopuerto de origen')
    aereo_destino = fields.Many2one('res.country.aereo', 'Aereopuerto de destino')
    frontera_origen = fields.Many2one('res.country.frontera', 'Frontera de origen')
    frontera_destino = fields.Many2one('res.country.frontera', 'Frontera de destino')
