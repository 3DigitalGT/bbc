...
#aqui qui aqui PruebaJP
    ...
    so_incotermsclientes = fields.Many2one('account.incoterms','Tipo de Incoterms del Cliente',ondelete='cascade',select=True)
    so_incotermservicios = fields.Many2one('account.incoterms','Tipo de Incoterms del Cliente',ondelete='cascade',select=True)
